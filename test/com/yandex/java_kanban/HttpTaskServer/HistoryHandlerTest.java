...
public class HistoryHandlerTest {
    ...
    public void shouldReturnPrioritizedTaskList() throws IOException, InterruptedException {
        ...
        List<Task> history = gson.fromJson(httpResponse.body(), taskListType);
        assertEquals(200, httpResponse.statusCode());
        assertNotNull(history, "Список задач пуст");
        assertEquals(3, history.size(), "некорректное число задач.");
    }
}
